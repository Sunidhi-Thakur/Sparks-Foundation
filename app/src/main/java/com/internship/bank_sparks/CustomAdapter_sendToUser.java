...
public class CustomAdapter_sendToUser extends RecyclerView.Adapter<ViewHolder> {

    sendtouser SendtoUser;
    List<Model> modelList;

    public CustomAdapter_sendToUser(sendtouser sentoUser, List<Model> modelList) {
